...
<style scoped>
    div{
        background-color: rgba(123, 250, 80, 0.3);
        padding: 0.3rem;
        margin-top:1rem;
        color: white;
        border: solid #50fa53 1px;
    }
    div svg{
        margin-top: 0.2rem;
        margin-right: 0.2rem;
        color: rgb(123, 250, 80);
    }
</style>